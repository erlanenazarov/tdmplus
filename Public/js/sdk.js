/**
 * Created by Эрлан on 27.08.2016.
 */
/*1472302408,,JIT Construction: v2530733,ru_RU*/
...
try {
    window.FB || (function (window, fb_fif_window) {
        ...
        (function () {
            ...
            with (this) {
                ...
                __d("JSSDKRuntimeConfig", [], {"locale": "ru_RU", "rtl": false, "revision": "2530733"});
                __d("JSSDKConfig", [], {
                    "bustCache": true,
                ...
                __d('URISchemes', ['createObjectFrom'], function a(b, c, d, e, f, g, h) {
                    if (c.__markCompiled)c.__markCompiled();
                    var i = h(['blob', 'cmms', 'fb', 'fbatwork', 'fb-ama', 'fb-messenger', 'fb-page-messages', 'fbcf', 'fbconnect', 'fbmobilehome', 'fbrpc', 'file', 'ftp', 'http', 'https', 'mailto', 'ms-app', 'intent', 'itms', 'itms-apps', 'itms-services', 'market', 'svn+ssh', 'fbstaging', 'tel', 'sms', 'pebblejs', 'sftp', 'whatsapp', 'moments', 'fblite', 'chrome-extension']), j = {
                ...
                __d('CORSRequest', ['wrapFunction', 'QueryString', 'errorCode'], function a(b, c, d, e, f, g, h, i, j) {
                    ...
                    function k(n, o) {
                        ...
                        var p = new XMLHttpRequest(), q = function v() {
                        };
                ...
                __d('ApiClient', ['ArgumentError', 'Assert', 'CORSRequest', 'FlashRequest', 'flattenObject', 'JSONPRequest', 'Log', 'ObservableMixin', 'QueryString', 'sprintf', 'sdk.URI', 'UrlMap', 'ApiClientConfig', 'invariant'], function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u) {
                    ...
                    function ka(ua, va, wa, xa) {
                        ...
                        wa = l(wa);
                        var za = {jsonp: m, cors: j, flash: k}, ab = {}, bb = wa.access_token || v;
                        ...
                        for (var eb = 0; eb < db.length; eb++) {
                            var fb = za[db[eb]], gb = ES('Object', 'assign', false, {}, wa);
                    ...
                    var y = o.extend({
                        ...
                        _createMobileLoader: function aa() {
                            ...
                            if (p.nativeApp()) {
                                ...
                                ba = '<div class="overlayLoader">' + '<div id="fb_dialog_loader_spinner"></div>' + '<a id="fb_dialog_loader_close" href="#">' + q._("\u041e\u0442\u043c\u0435\u043d\u0430") + '</a>' + '</div>';
                            } else ba = '<div class="dialog_header">' + '<table>' + '  <tbody>' + '    <tr>' + '      <td class="header_left">' + '        <label class="touchable_button">' + '          <input type="submit" value="' + q._("\u041e\u0442\u043c\u0435\u043d\u0430") + '"' + '            id="fb_dialog_loader_close"/>' + '        </label>' + '      </td>' + '      <td class="header_center">' + '        <div>' + '         ' + q._("\u0417\u0430\u0433\u0440\u0443\u0437\u043a\u0430...") + '        </div>' + '      </td>' + '      <td class="header_right">' + '      </td>' + '    </tr>' + '  </tbody>' + '</table>' + '</div>';
                    ...
                    var q = l.extend({
                        constructor: function r(s, t, u, v) {
                            ...
                            this.subscribe('xd.savePluginGetBlankIframe', ES(function (x) {
                                var y = void 0, z = void 0, aa = void 0, ba = function ga(ha) {
                            ...
                            var v = '#' + m.encode({forIframe: t}), w = i.setupNewDialog();
                            p({
    ...
    new Image().src = "https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"2530733","namespace":"FB","message":"' + e.message + '"}}');
}